...
namespace math
{
    /**
		...
		of methods and easier interoperability with Vector2.
    */
    class Vector3
    {
	...
	/** Returns the x and y components of this vector as a Vector2 */
	inline Vector2 xy(const Vector3& v) { return Vector2(v.x, v.y); }
	/** Returns the y and x components of this vector as a Vector2 */
	inline Vector2 yx(const Vector3& v) { return Vector2(v.y, v.x); }

	/** Returns the x and z components of this vector as a Vector2 */
	inline Vector2 xz(const Vector3& v) { return Vector2(v.x, v.z); }
	/** Returns the z and x components of this vector as a Vector2 */
	inline Vector2 zx(const Vector3& v) { return Vector2(v.z, v.x); }

	/** Returns the y and z components of this vector as a Vector2 */
	inline Vector2 yz(const Vector3& v) { return Vector2(v.y, v.z); }
	/** Returns the z and y components of this vector as a Vector2 */
	inline Vector2 zy(const Vector3& v) { return Vector2(v.z, v.y); }
